                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <a href="javascript:void(0);">
                                <img id="output" src="{{$userdata->user_image_url}}" class="rounded-circle img-center img-fluid shadow shadow-lg--hover" style="width: 140px;">
                            </a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group @if($errors->has('name')) has-danger @endif ">
                                ...
                                <input type="text" class="form-control  @if($errors->has('name')) is-invalid @endif maxlength" name="name" id="name" placeholder="Name" value="{{old('name',$userdata->name)}}">
                                @if($errors->has('name'))
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group @if($errors->has('email')) has-danger @endif ">
                                ...
                                <input type="text" class="form-control  @if($errors->has('email')) is-invalid @endif maxlength" name="email" id="email" placeholder="Email" value="{{old('email',$userdata->email)}}">
                                @if($errors->has('email'))
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label class="custom-toggle custom-toggle-success">
                                    <input type="checkbox" {{$userdata->status =='1' ? 'checked' : ''}} value="1" name="status">
