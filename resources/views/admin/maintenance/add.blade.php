              ...
              <div class="row">
                <div class="col-md-5 main-img">
                  <div class="form-group">
                    ...
                    <div class="dropzone dropzone-single mb-3" data-toggle="dropzone" data-dropzone-url="{{route('admin.maintenance.mainupload',['id' => $guide->id])}}" data-dropzone-accepted-files=".jpeg,.jpg,.png" dropzone-max-file-size="2028">
                      <div class="fallback">
