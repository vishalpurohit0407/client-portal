    ...
    <div class="container-fluid mt--6">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form class="form" action="{{ route('admin.cms.page.store') }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group @if($errors->has('title')) has-danger @endif ">
                                ...
                                <input type="text" class="form-control  @if($errors->has('title')) is-invalid @endif maxlength" name="title" id="title" placeholder="Title" value="{{old('title')}}">
                                @if($errors->has('title'))
