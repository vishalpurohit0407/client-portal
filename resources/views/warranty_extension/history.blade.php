              ...
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                    ...
                    @csrf
                        ...
                        <a href="javascript:void(0);"  onclick="addNewConfirm(this);" type="submint" class="btn btn-sm btn-primary">Submit a new warranty extension</a>
                    </form>
                </div>
              </div>
            </div>
                                ...
                                <div class="checklist-item checklist-item-{{$color[$warranty->status]}}">
                                    ...
                                    <div>
                                        <div class="custom-control custom-checkbox custom-checkbox-success">
                                          ...
                                          @else
                                            @if($warranty->status != 0)
                                              <a href="{{route('user.warranty_extension.edit',$warranty->id)}}" class="btn btn-info">Edit</a>
                                            @endif
                                          @endif
                                        </div>
                                    </div>
